        ...
        <div className="w-screen justify-center pt-12 flex  font-classy ">
          <div className=" w-[80%] flex gap-3  bg-white h-[80%] p-7">
            <div className="w-[40%] flex shadow-2xl flex-col justify-evenly">
              <div className="  shadow-2xl gap-5 rounded-2xl h-[30%] items-center flex p-3">
                ...
                <div className="flex gap-2 flex-col  ">
                  <h3 className="text-3xl font-bold ">Vishwas Verma</h3>
                  
                </div>
              </div>

              <div className=" h-[35%] text-center shadow-2xl text-black rounded-3xl bg-white">
                <h3 className="text-xl font-bold shadow-md py-2">
                  Your Top 3 Score
                </h3>
                <div className="flex gap-3 bg-white px-3 my-3 text-xl">
                  <table>
                    <tr>
                      <td>
              ...
              <div className="  flex items-center w-full bg-white text-center text-black rounded-3xl ">
                <div className="flex items-center h-32 w-full  justify-evenly shadow-2xl rounded-2xl  ">
            ...
            <div className="w-full  flex-wrap overflow-auto h-full rounded-2xl  flex flex-col justify-around p-4 px-6  bg-white   ">
              <p className="text-xl">
                Hello i m Vishwas kumar verma , Lorem ipsum, dolor sit amet consectetur adipisicing elit. Sapiente magni, facilis mollitia, quos totam . Lorem ipsum dolor sit amet
                consectetur adipisicing elit. Delectus, dolor reprehenderit
                accusamus sed ipsa, fugit aperiam. Voluptatibus, cum.
              </p>
              <div className="mt-3 flex flex-col gap-3 text-xl">
                <h1>Name : Vishwas </h1>
                <h1>Age : 23</h1>
                <h1>Gender : male</h1>
                <h1>Gmail : vv54254@gmail.com</h1>
                <h1>PNo :123456789</h1>
                <h1>Address : Mirjapur</h1>
              </div>

              <div className="mt-3 flex gap-3 flex-wrap ">
                <span className="p-2 px-6 text-white rounded-2xl bg-[#07012d]">
                  C
                </span>
                <span className="p-2 px-6 text-white rounded-2xl bg-[#07012d]">
                  JAVA
